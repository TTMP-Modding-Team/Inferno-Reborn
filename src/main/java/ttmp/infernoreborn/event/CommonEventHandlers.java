...
public class CommonEventHandlers{
	...
	public static void onLivingUpdate(LivingUpdateEvent event){
		...
		if(h!=null){
			...
			if(h instanceof ServerAbilityHolder){
				for(OnAbilityEvent<LivingUpdateEvent> e : ((ServerAbilityHolder)h).getOnUpdateListeners().values())
	...
	public static void onLivingDeath(LivingDeathEvent event){
		...
		ServerAbilityHolder h = ServerAbilityHolder.of(entity);
		if(h!=null){
			for(OnAbilityEvent<LivingDeathEvent> e : h.getOnDeathListeners().values())
				e.onEvent(entity, h, event);
		}
	}
