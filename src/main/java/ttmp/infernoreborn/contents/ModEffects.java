...
public final class ModEffects{
	...
	public static final RegistryObject<Effect> DIABOLO = REGISTER.register("diabolo", () -> new SimpleEffect(EffectType.BENEFICIAL, 0xFFFFFF)
	...
	public static final RegistryObject<Effect> FEAR = REGISTER.register("fear", () -> new SimpleEffect(EffectType.HARMFUL, 0xFFFFFF)
	...
	public static final RegistryObject<Effect> KILLER_QUEEN = REGISTER.register("killer_queen", () -> new SimpleEffect(EffectType.HARMFUL, 0x0));
	public static final RegistryObject<Effect> HAND_OF_MIDAS = REGISTER.register("hand_of_midas", () -> new SimpleEffect(EffectType.HARMFUL, 0xFFF35A));
}
