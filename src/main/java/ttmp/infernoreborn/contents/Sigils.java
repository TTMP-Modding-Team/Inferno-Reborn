...
import ttmp.infernoreborn.sigil.TestSigil;
...
public final class Sigils{
	...
	public static final RegistryObject<Sigil> TEST = REGISTER.register("test", () -> new TestSigil(new Sigil.Properties(0xea1f1f, 0x820909, 3).item(ModItems.TEST_SIGIL.get())));
	public static final RegistryObject<Sigil> TEST2 = REGISTER.register("test2", () -> new TestSigil(new Sigil.Properties(0x1668ec, 0x062a63, 4).item(ModItems.TEST_SIGIL_2.get())));
