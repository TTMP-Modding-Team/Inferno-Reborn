...
public final class WindAbility{
	...
	public static Ability wind(int tier){
		return new Ability(new Ability.Properties(0xA1CEE3, 0xA1CEE3)
	...
	public static Ability blindingWind(){
		return new Ability(new Ability.Properties(0xFF680C, 0xFF680C)
	...
	public static Ability freezingWind(){
		return new Ability(new Ability.Properties(0x92B9FA, 0x92B9FA)
	...
	public static Ability poisoningWind(){
		return new Ability(new Ability.Properties(0x4E9331, 0x4E9331)
