...
public final class ColorUtils{
	...
	public static final ColorBlender PRIMAL_SPARK_PRIMARY_COLOR = new ColorBlender(2000){
		@Override protected int createNewColor(){
			return ColorUtils.hslToRgb(RNG.nextDouble()*360, .75, .9);
		}
	};
	public static final ColorBlender PRIMAL_SPARK_SECONDARY_COLOR = new ColorBlender(200){
		@Override protected int createNewColor(){
