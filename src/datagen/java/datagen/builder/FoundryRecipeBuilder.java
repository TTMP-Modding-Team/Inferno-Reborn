	...
	public void save(Consumer<IFinishedRecipe> consumer, ResourceLocation id){
		...
		consumer.accept(new IFinishedRecipe(){
			@Override public void serializeRecipeData(JsonObject object){
				...
				EssenceIngredient essences = FoundryRecipeBuilder.this.essences.build();
				if(!essences.isEmpty()) object.add("essences", essences.toJsonObject());
				if(processingTime!=FoundryRecipe.DEFAULT_PROCESSING_TIME)
					object.addProperty("processingTime", processingTime);
